<template>
  ...
  <v-row class="d-flex align-center justify-center pa-6" style="background-color: rgb(242, 247, 252)">
    <titre-section titre="Pourquoi Constellation ?" :sous-titre="['Constellation est un réseau pair-à-pair pour le partage des données scientifiques.', 'Il vous permet de collecter et de publier les données de vos projets sans utilisation de serveur centralisé.']"/>

    <v-col cols="auto">
      <carte-fonctionalite titre="Science citoyenne" sous-titre="Obtenez des données en directe de vos participants sur le terrain, sans jamais avoir à vous inquiéter d'un serveur." :image="imgScienceCitoyenne"/>
    </v-col>
    <v-col cols="auto">
      <carte-fonctionalite titre="Reproductibilité" sous-titre="Chacune de vos bases de données est accessible selon un identifiant unique. Il n'y a que vous qui pouvez la modifier." :image="imgSécurité"/>
    </v-col>
    <v-col cols="auto">
      <carte-fonctionalite titre="Sécurité" sous-titre="Vos données resteront disponibles tant qu'au moins une autre personne sur le réseau s'y intéresse. Même si vous échapez votre thé sur votre ordi." :image="imgThé"/>
    </v-col>
    <v-col cols="auto">
      <carte-fonctionalite titre="Intégration en continue" sous-titre="Configurez vos analyses en Python, R ou Julia et elles suivront en directe toute mise à jour des bases de données." :image="imgCode"/>
    </v-col>
  </v-row>
  <v-row class="d-flex align-center justify-center pa-6">
    <titre-section titre="Démarrer" :sous-titre="['Vous pouvez utiliser Constellation en ligne, l\'installer sur votre ordinateur, ou bien l\'accéder dans votre langage de programmation favori.']" />
    <v-col cols="auto">
      <v-card width="300" height="330" class="text-center"  @click="()=>ouvrirLien('https://appli.réseau-constellation.ca')">
        ...
        <v-card-text>
          ...
          Aucune installation nécessaire. Disponible sur téléphone et navigateur (pas de Safari, désolé) !
        </v-card-text>
      </v-card>
    </v-col>

    <v-col cols="auto">
      <v-card width="300" height="330" class="text-center" @click="async ()=>lienTéléchargementDirecte ? ouvrirLien(lienTéléchargementDirecte) : $router.push(encodeURI('/téléchargements'))">
        <v-card-item class="mt-4">
    ...
    <v-col cols="auto">
      <v-card width="300" height="330" class="text-center" @click="()=>ouvrirLien('https://docu.réseau-constellation.ca/avancé/autresLangages/introduction.html')">
        <v-card-item class="mt-4">
    ...
    <v-col cols="auto">
      <v-card width="300" height="330" class="text-center" @click="()=>ouvrirLien('https://docu.réseau-constellation.ca')">
        <v-card-item class="mt-4">
